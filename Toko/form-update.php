...
if(isset($_POST['submit'])){
  ...
  $sql="UPDATE customer SET id=$id, nama='$name',alamat='$alamat',mobile='$mobile',email='$email' WHERE id=$id";
  $result=mysqli_query($konek, $sql);
  if($result){
...
<nav class="navbar navbar-light bg-light">
 ...
 <header>
    ...
    <h1 class="text-white"> Edit Data Customer</h1>
</figure>
<!-- Tabel Tampilan Edit/Update Customer -->
      <!-- tombol home -->
...
<form method="post">
  ...
  <div class="form-row">
    <div class="col-md-5 mb-4 text-white">
      ...
      placeholder="Nama Lengkap" name="nama" value=<?php echo $name;?> required>
  ...
  <div class="form-group col-md 15 text-white">
      ...
      placeholder="08123..." name="mobile" value=<?php echo $mobile;?> required>
    ...
    <div class="form-group col-md 5 text-white">
      ...
      placeholder="anggrek123@gmail.com" name="email" value=<?php echo $email;?> required>
      <div class="invalid-feedback">
    ...
    <div class="form-group row-md-2 text-white">
      ...
      placeholder="Jl. Anggrek ..." name="alamat" value=<?php echo $alamat;?> required>
      <div class="invalid-feedback">
    ...
    name="submit">Update & Save</button>
        </div>
       </form>
      </div>
    </div>
